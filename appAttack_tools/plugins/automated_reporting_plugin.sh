...
# WHAT THIS DOES:
# After the "Penetration Testing Team" runs security scans, this takes all the result files and bundles them into ONE .html file you can open in your browser.
...
run_plugin() {
    ...
    # Create a file name that includes the current date and time, you can find this files in the GitHub repo under reports.
